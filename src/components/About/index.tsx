      ...
      <section className="about-equipment">
        <Container>
          <div className="about-equipment-content">
            <span>
              <FormatQuoteIcon />
              Единый стиль оформления пространства клиники создает
              дополнительное ощущение того, что вы находитесь в дорогом отеле
              Швейцарии. Приходите и убедитесь, что зубы тоже можно лечить со
              вкусом!
              <FormatQuoteIcon />
            </span>
            <img src={img5} alt="" />
            <p>
              ...
              предоставить диагностику подобного уровня. Стоматологические
              установки и аппараты, созданные по инновационным технологиям в
              Европе, имеют высокую точность и достоверность при лечении. Все
              кабинеты клиники оснащены высокоточным оборудованием, в арсенале
              наших специалистов: мобильная рентгеновская аппаратура для
              дополнительной диагностики, которая избавляет пациентов от
